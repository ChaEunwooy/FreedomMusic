...
const Banner: FC = () => {
  ...
  return (
    ...
    >
      <img
        src={config?.bgImage || 'https://images.unsplash.com/photo-1500375592092-40eb2168fd21?q=80&w=1200'}
      ...
      <div className="absolute inset-0 flex flex-col justify-center p-14 pointer-events-none">
        <h2 className="text-3xl font-bold text-white mb-2 transition-all duration-500">
          {selectedMood ? MOOD_CONFIGS[selectedMood].label : 'Daily Flow'}
        </h2>
