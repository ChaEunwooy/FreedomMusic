      ...
      <div className="relative" ref={menuRef}>
        ...
        {open && (
          <div className="absolute right-0 top-full mt-1 z-50 bg-white/10 backdrop-blur-2xl rounded-xl py-1.5 min-w-[140px] shadow-xl border border-white/15">
            <MenuItem icon={faPlay} label={t('menu.play')} onClick={handlePlay} />
            <MenuItem icon={faForward} label={t('menu.play_next')} onClick={handleInsertNext} />
            ...
            />
            <MenuItem icon={faListOl} label={t('menu.add_to_playlist')} onClick={handleAddToPlaylist} />
          </div>
        )}
      </div>
      <AddToPlaylistModal
